...
# pip install pyqt5
# pip install pyserialpip install pyserial
...
class EEGThread(threading.Thread):
    ...
    def __init__(self, parent=None):
        ...
        self.com = "/dev/tty.usbserial-1110"
        self.bps = 57600
        self.vaul = []
        self.is_open = False
        self.is_close = True
    ...
    def run(self):
        ...
        try:
            ...
            print(str(time.strftime('%Y-%m-%d %H:%M:%S',
                  time.localtime(time.time())))+"脑电波设备配对中")
                ...
                if a[0] == 170 and a[1] == 170 and a[2] == 4 and a[3] == 128 and a[4] == 2:
                    while 1:
                        try:
                            ...
                            a = t.read(8)
                            sum = (
                                (0x80 + 0x02 + a[5] + a[6]) ^ 0xffffffff) & 0xff
